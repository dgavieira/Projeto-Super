package com.projetosuper.calculadora_cientifica;


//supresslint interface: https://developer.android.com/reference/android/annotation/SuppressLint
//Supresslint indicates that code should ignore specific warnings for the annotated element.
/*Usei supresslint pra evitar alguns bugs que eu tava batendo cabeça, principalmente com as operaçoes
que usam apenas uma entrada */
...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnClick_pi(View view){
        ...
        input.setText(input.getText() + pi_str);
    }

    @SuppressLint("SetTextI18n")
    public void btnClick_neper(View view){
        double neper = Math.E;
        String neper_str = String.valueOf(neper);
        input.setText(input.getText() + neper_str);
    }
